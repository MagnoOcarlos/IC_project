...
//	TRint *rint = new TRint("", &argc, argv);	
	...
	const char *filename0  ="../ang0.txt";
	const char* filename20 ="../ang20.txt";
	const char* filename40 ="../ang40.txt";
	const char* filename60 ="../ang60.txt";
	const char* filename80 ="../ang80.txt";
	...
	hArrive0->GetXaxis()->SetTitle("Log(E)");
	hArrive0->Draw("HIST");
