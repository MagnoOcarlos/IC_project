...
//	TRint *rint = new TRint("", &argc, argv);	
	...
	const char *filename0  ="../distance_20Mpc.txt";
	const char* filename20 ="../distance_40Mpc.txt";
	const char* filename40 ="../distance_60Mpc.txt";
	const char* filename60 ="../distance_80Mpc.txt";
