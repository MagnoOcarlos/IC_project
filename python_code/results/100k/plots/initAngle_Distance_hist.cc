...
//	TRint *rint = new TRint("", &argc, argv);	
	...
	const char* filename20 ="../Distance_ang5.txt";
	const char* filename40 ="../Distance_ang10.txt";
	const char* filename60 ="../Distance_ang15.txt";
	const char* filename80 ="../Distance_ang20.txt";
