{
	...
	auto hChegada0 = new TH1D("hChegada0","", 50, -9,0);
	auto hChegada20 = new TH1D("hChegada20","", 50, -9,0);
	auto hChegada40 = new TH1D("hChegada40"," ", 50, -9,0);
	

	auto hChegada60 = new TH1D("hChegada60","", 50, -9,0);
	auto hChegada80 = new TH1D("hChegada80","", 50, -9,0);
	...
	for(int i=0; i <=24278;i++){
		...
		input0 >>E;
		hChegada0->Fill(log10(E));
	}

	for(int i=0; i <=3375;i++){
		
		input20 >>E;
		hChegada20->Fill(log10(E));
	}

	for(int i=0; i <=2440;i++){
		
		input40 >>E;
		hChegada40->Fill(log10(E));
	}

	for(int i=0; i <=2127;i++){
		
		input60 >>E;
		hChegada60->Fill(log10(E));
	}

	for(int i=0; i <=2102;i++){
		
		input80 >>E;
		hChegada80->Fill(log10(E));
	}
