{
	...
	auto hChegada0 = new TH1D("hChegada0","", 50, 3,103);
	auto hChegada20 = new TH1D("hChegada20","", 50, 3,103);
	auto hChegada40 = new TH1D("hChegada40"," ", 50, 3,103);
	

	auto hChegada60 = new TH1D("hChegada60","", 50, 3,103);
	auto hChegada80 = new TH1D("hChegada80","", 50, 3,103);
	...
	ifstream input0("../100k/Distance_ang0.txt");
	ifstream input20("../100k/Distance_ang20.txt");
	ifstream input40("../100k/Distance_ang40.txt");

	ifstream input60("../100k/Distance_ang60.txt");
	ifstream input80("../100k/Distance_ang80.txt");
...
//	h1->GetYaxis()->SetTitle("#frac{h_{arr}}{h_{inj}}");
	h1->GetXaxis()->SetTitle("Trajectory Len[Mpc]");
	h1->Draw("HIST");
